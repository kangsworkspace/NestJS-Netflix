...
describe('DirectorController', () => {
  ...
  describe('findAll', () => {
    it('should call findAll method from DirectoryService', async () => {
  ...
  describe('findOne', () => {
    it('should call findOne method from Director Service with correct ID', async () => {
      const result = { id: 1, name: 'codefactory' };
  ...
  describe('create', () => {
    it('should call create method form DirectorService with correct DTO', async () => {
  ...
  describe('remove', () => {
    it('should call remvoe method form DirectorService with correct ID', async () => {
      const result = 1;
