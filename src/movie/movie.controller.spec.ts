...
describe('MovieController', () => {
  ...
  describe('getMovies', () => {
    it('should call movieServie.findAll with the correct parameters', async () => {
    ...
    describe('recent', () => {
    it('should call movieServie.findRecent', async () => {
      const dto = { page: 1, limit: 10 };
      const userId = 1;
      const movies = [{id: 1}, {id: 2}];
  ...
  describe('postMovie', () => {
    ...
    describe('patchMovie', () => {
      it('should call movieService with correct parameters', async () => {
        const id = 1;
