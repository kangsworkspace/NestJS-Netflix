...
describe('AuthService', () => {
  ...
  describe('parseBasicToken', () => {
    ...
    it('should throw an error for invalid token format', () => {
      ...
      // 그냥 에러를 던질때는 expect 안에 함수로 던져야 한다.
      expect(() => authService.parseBasicToken(rawToken)).toThrow(BadRequestException);
    });

    it('should throw an error for invalid Beaer token format', () => {
  ...
  describe('parseBearerToken', () => {
    ...
    it('should throw an UnauthorizedException if payload.type is not refresh but isRefreshToken parameter is true', () => {
  ...
  describe('authenticate', () => {
    ...
    it('should throw an error for incorrect password', async () => {
      ...
      await expect(authService.authenticate('test@codefactory.ai', 'password')).rejects.toThrow(BadRequestException);
    });
  });
