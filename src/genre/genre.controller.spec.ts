...
describe('GenreController', () => {
  ...
  describe('findAll', () => {
    it('should call genreService.findAll and return array of genres', async () => {
  ...
  describe('findOne', () => {
    it('should call genreService.findOne with correct id and return the genre', async () => {
      ...
      expect(service.findOne).toHaveBeenLastCalledWith(id);
    });
  });
  ...
  describe('remove', () => {
    it('should call genreService.remove with correct id and return id of the removed gnere', async () => {
      const id = 1;
